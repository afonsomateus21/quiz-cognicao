...
export function ReinforcementeDescriptionCard({ color, children } : ReinforcementeDescriptionCardProps) {
  return (
    <section className={`${color} w-full h-64 p-4 rounded-3xl relative`}>
